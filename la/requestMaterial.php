...
Wir suchen nun nach Übermittlungsmöglichkeiten von Morsen: Schreiben, klopfen, Licht, Stimme, pfeifen, etc.
...
- Verkleidung Schiffskapitän
- Beispiele für die verschiedenen Seiltypen (Hanfseil, Bergseil, Statikseil, Polypropylenseil)
- Pfaditechnik-Buch mit Morseschlüssel
- Papier und Stifte
- Taschenlampen
- Sonnenspiegel
...
Vollständiges benötigtes Material für dieses Programm:
- Verkleidung Fernsehmoderatorin
- Blachen
- Seile
- Äste um die Seile auseinanderzudrücken
- Sackmesser
- Apotheke",
...
Vollständiges benötigtes Material für dieses Programm:
- Verkleidung Apollon und Athena
- Zundhölzer
- Schnurstücke
- 2 Krokis mit Wegbeschreibung zu versteckten Blachen
- 2 Kompasse mit Azimut- und Distanzangaben zu versteckten Seilen
- 2 Karten mit Koordinaten von versteckten Naturkunde-Unterlagen und Feuersachen
- 6 Pfaditechnik-Bücher
- 26 Blachen
- 12 Zelteinheiten
- Diverse Seile
- 2 Listen mit Knoten
- 2 Couverts mit Bildern und Beschreibungen von Pflanzen
- 2 Feuerzeuge
- Zeitungspapier
- Schnur zum durchbrennen
- Verkleidung Zeus
- Requisiten für Unfallsituation
- Apotheke
- Trinkwasser für zwischendurch",
    ],
    'piostufe' => [
...
Vollständiges benötigtes Material für dieses Programm:
- Zettel und Stifte für alle beteiligten
- Sugus in diversen Farben
- 1 Seil pro 3-4 TN
- Augenbinden oder Pfadikrawatten für alle TN
- Feuersachen
...
$messages = [
    ['role' => 'system', 'content' => "Schreibe eine Materialliste für eine Pfadi-Lageraktivität für {$targetGroupDescription}. Vorgegeben sind die Lerninhalte sowie das Programm der Aktivität.
